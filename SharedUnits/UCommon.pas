...
uses
  ...
  Grids, DBGrids, ComCtrls,define,db,dbTables, StdCtrls, ADODB, ExtCtrls,inifiles,fard,Variants,DBCtrls,Menus,buttons,ppCtrls,ppReport;
//---------------------------------------------------------
//---------------------------------------------------------
...
type
  ...
  TPageType=(pgA4,PgA5,PgA3,PgCustom);
const
...
{  procedure CheckGridKeyPress( Sender: TForm; var Key: Char);}
  ...
  function CheckPrintPage(var ppReport:TppReport):TppShape;
  function SetPrintPage(RoundLine:Boolean;PageType:TPageType; var ppReport:TppReport):TppShape;
...
function  fullCmdPath:String;
begin
  result:=windowsPath+'\'+GetProductInformation('ProductName')+CmdFileName;
end;
function  fullIniPath:String;
begin
...
begin
  ...
  begin
    ...
    BorderRound.Band:=ppReport.HeaderBand;
    ...
    else if PageType='A4' then
    begin
      ppReport.PrinterSetup.PaperHeight:=11.697899818;
      BorderRound.Height:=10.76;
    end;
    result:=BorderRound;
  end
  else
...
begin
  ...
  begin
    ...
    BorderRound.SendToBack;
    ppReport.PrinterSetup.PaperWidth:=8.2707996368;
    if PageType=pgA5 then
    begin
      ppReport.PrinterSetup.PaperHeight:=5.848949909;
      BorderRound.Height:=5.2;
    end
    else if PageType=pgA4 then
    begin
      ppReport.PrinterSetup.PaperHeight:=11.697899818;
      BorderRound.Height:=10.76;
    end;

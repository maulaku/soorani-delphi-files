...
procedure TCalculatorForm.N2Click(Sender: TObject);
var
  mes:TMessage;
begin
  inherited;
  if ClassName='TSciCalcForm' then
  begin
    SendMessage(Application.MainForm.Handle,WM_USER+101,0,0);
    Close;
  end;
end;

procedure TCalculatorForm.N3Click(Sender: TObject);
begin
  inherited;
  if ClassName='TCalculatorForm' then
  begin
    SendMessage(Application.MainForm.Handle,WM_USER+101,1,1);
    Close;
  end;
end;

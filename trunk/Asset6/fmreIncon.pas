...
procedure TreStampSpec1.DoRun(var mes :TMessage);
...
procedure TreStampSpec1.DoPrint(var mes :TMessage);
begin
  ppViewer1.Print;
end;

procedure TreStampSpec1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 FormDeactivate(nil);
{ recredit:=nil;}
 Action:=CaFree;
...
procedure TreStampSpec1.FormActivate(Sender: TObject);
var mes:TMessage;
begin
   mes.Msg := FORM_STATE;
   mes.Lparam := 45;
...
procedure TreStampSpec1.FormDeactivate(Sender: TObject);
var mes:TMessage;
begin
 mes.Msg:=FORM_DEACT;
 Application.MainForm.Dispatch(mes);
...
procedure TreStampSpec1.spbPreview100PercentClick(Sender: TObject);
begin
...
procedure TreStampSpec1.spbPreviewWidthClick(Sender: TObject);
begin
...
procedure TreStampSpec1.spbPreviewWholeClick(Sender: TObject);
begin
...
procedure TreStampSpec1.mskPreviewPageKeyPress(Sender: TObject; var Key: Char);
var
  liPage: Longint;
begin
...
procedure TreStampSpec1.spbPreviewNextClick(Sender: TObject);
begin
  ppViewer1.NextPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreStampSpec1.spbPreviewPriorClick(Sender: TObject);
begin
  ppViewer1.PriorPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreStampSpec1.mskPreviewPercentageKeyPress(Sender: TObject;
  var Key: Char);
var
...
procedure TreStampSpec1.quFunFormalRowGetText(Sender: TField;
...
procedure TreStampSpec1.ppDBText2GetText(Sender: TObject; var Text: String);
begin
  Text := inttostr(i div 3);
  i := i+1;
end;

procedure TreStampSpec1.FormShow(Sender: TObject);
begin
...
procedure TreStampSpec1.dblUnitCloseUp(Sender: TObject);
begin
...
procedure TreStampSpec1.dblCostCenterCloseUp(Sender: TObject);
begin
      DabData.quDeployLoc.Close;
...
procedure TreStampSpec1.dblCostCenterEnter(Sender: TObject);
begin
...
procedure TreStampSpec1.dblLocCodeEnter(Sender: TObject);
begin

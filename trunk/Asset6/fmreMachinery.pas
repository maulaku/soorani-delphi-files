...
type
  TreSpecMachinery = class(TForm)
    ...
    quSpecMuseumSts_gcode: TLargeintField;
    ...
    quSpecMuseumMyGoodCode: TLargeintField;
...
var
  reSpecMachinery: TreSpecMachinery;
...
procedure TreSpecMachinery.DoRun(var mes :TMessage);
begin
 if ((dblUnit.text<>'') and (dblCostCenter.text<>'') and (dblLocCode.text<>'') ) then
   begin
     ...
     quSpecMuseum.close;
     quSpecMuseum.Parameters[0].value := dblUnit.KeyValue;
     quSpecMuseum.Parameters[1].value := dblCostCenter.KeyValue;
     quSpecMuseum.Parameters[2].value := dblLocCode.KeyValue;
     quSpecMuseum.open;
...
procedure TreSpecMachinery.DoPrint(var mes :TMessage);
begin
  ppViewer1.Print;
end;

procedure TreSpecMachinery.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 FormDeactivate(nil);
{ recredit:=nil;}
 Action:=CaFree;
...
procedure TreSpecMachinery.FormActivate(Sender: TObject);
var mes:TMessage;
begin
   mes.Msg := FORM_STATE;
   mes.Lparam := 45;
...
procedure TreSpecMachinery.FormDeactivate(Sender: TObject);
var mes:TMessage;
begin
 mes.Msg:=FORM_DEACT;
 Application.MainForm.Dispatch(mes);
...
procedure TreSpecMachinery.spbPreview100PercentClick(Sender: TObject);
begin
...
procedure TreSpecMachinery.spbPreviewWidthClick(Sender: TObject);
begin
...
procedure TreSpecMachinery.spbPreviewWholeClick(Sender: TObject);
begin
...
procedure TreSpecMachinery.mskPreviewPageKeyPress(Sender: TObject; var Key: Char);
var
  liPage: Longint;
begin
...
procedure TreSpecMachinery.spbPreviewNextClick(Sender: TObject);
begin
  ppViewer1.NextPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreSpecMachinery.spbPreviewPriorClick(Sender: TObject);
begin
  ppViewer1.PriorPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreSpecMachinery.mskPreviewPercentageKeyPress(Sender: TObject;
  var Key: Char);
var
...
procedure TreSpecMachinery.quFunFormalRowGetText(Sender: TField;
...
procedure TreSpecMachinery.ppDBText2GetText(Sender: TObject; var Text: String);
begin
  Text := inttostr(i div 3);
  i := i+1;
end;

procedure TreSpecMachinery.FormShow(Sender: TObject);
begin
...
procedure TreSpecMachinery.dblUnitCloseUp(Sender: TObject);
begin
...
procedure TreSpecMachinery.dblCostCenterCloseUp(Sender: TObject);
begin
      DabData.quDeployLoc.Close;
...
procedure TreSpecMachinery.dblCostCenterEnter(Sender: TObject);
begin
...
procedure TreSpecMachinery.dblLocCodeEnter(Sender: TObject);
begin

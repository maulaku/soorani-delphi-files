...
type
  TreSpecBooks = class(TRadForm)
    ...
    ppLabel40: TppLabel;
    ppShape1: TppShape;
    quSpecBooksFLName: TStringField;
    quSpecBooksItem_name: TStringField;
    quSpecBooksRec_no: TIntegerField;
    quSpecBooksDate: TStringField;
    quSpecBooksbPrice: TFloatField;
    quSpecBooksEPrice: TFloatField;
    quSpecBooksbos_gcode: TStringField;
    quSpecBooksbos_name: TStringField;
    quSpecBooksbos_aut: TStringField;
    quSpecBooksbos_date: TStringField;
    quSpecBooksbos_trans: TStringField;
    quSpecBooksbos_publ: TStringField;
    quSpecBooksbos_num: TIntegerField;
    quSpecBooksbos_dim: TStringField;
    quSpecBooksbos_ptype: TStringField;
    quSpecBooksbos_ctype: TSmallintField;
    quSpecBooksbos_chtype: TSmallintField;
    quSpecBooksbos_cname: TStringField;
    quSpecBooksbos_desc: TStringField;
    quSpecBooksMyGoodCode: TStringField;
    quSpecBooksEmp: TStringField;
    quSpecBooksgoods_codeStr: TStringField;
    quSpecBooksbos_cTypeName: TStringField;
    quSpecBooksbos_chTypeName: TStringField;
    quSpecBooksState_Name: TStringField;
...
procedure TreSpecBooks.DoRun(var mes :TMessage);
begin
// if ((dblUnit.text<>'') and (dblCostCenter.text<>'') and (dblLocCode.text<>'') ) then
   begin
     ...
     quSpecBooks.close;
     quSpecBooks.Parameters[0].value := OrganizCode;
     if trim(dblunit.text)<>'' then
           quSpecBooks.Parameters[1].value := dblUnit.KeyValue
     else quSpecBooks.Parameters[1].value :=0;
     if trim(dblCostCenter.text)<>'' then
       quSpecBooks.Parameters[2].value := dblCostCenter.KeyValue
     else quSpecBooks.Parameters[2].value :=0;
     if trim(dblLocCode.text)<>'' then
        quSpecBooks.Parameters[3].value := dblLocCode.KeyValue
     else quSpecBooks.Parameters[3].value :=0;
     if trim(dblemp.text)<>'' then
        quSpecBooks.Parameters[4].value := dblemp.KeyValue
     else quSpecBooks.Parameters[4].value :=0;
...
procedure TreSpecBooks.DoPrint(var mes :TMessage);
begin
  ppViewer1.Print;
end;

procedure TreSpecBooks.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 FormDeactivate(nil);
{ recredit:=nil;}
 Action:=CaFree;
...
procedure TreSpecBooks.FormActivate(Sender: TObject);
var mes:TMessage;
begin
   mes.Msg := FORM_STATE;
   mes.Lparam := 69;
...
procedure TreSpecBooks.FormDeactivate(Sender: TObject);
var mes:TMessage;
begin
 mes.Msg:=FORM_DEACT;
 Application.MainForm.Dispatch(mes);
...
procedure TreSpecBooks.spbPreview100PercentClick(Sender: TObject);
begin
...
procedure TreSpecBooks.spbPreviewWidthClick(Sender: TObject);
begin
...
procedure TreSpecBooks.spbPreviewWholeClick(Sender: TObject);
begin
...
procedure TreSpecBooks.mskPreviewPageKeyPress(Sender: TObject; var Key: Char);
var
  liPage: Longint;
begin
...
procedure TreSpecBooks.spbPreviewNextClick(Sender: TObject);
begin
  ppViewer1.NextPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreSpecBooks.spbPreviewPriorClick(Sender: TObject);
begin
  ppViewer1.PriorPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreSpecBooks.mskPreviewPercentageKeyPress(Sender: TObject;
  var Key: Char);
var
...
procedure TreSpecBooks.quFunFormalRowGetText(Sender: TField;
...
procedure TreSpecBooks.ppDBText2GetText(Sender: TObject; var Text: String);
begin
  Text := inttostr(quSpecBooks.RecNo);
end;

procedure TreSpecBooks.FormShow(Sender: TObject);
begin
...
procedure TreSpecBooks.dblUnitCloseUp(Sender: TObject);
begin
...
procedure TreSpecBooks.dblCostCenterCloseUp(Sender: TObject);
begin
      DabData.quDeployLoc.Close;
...
procedure TreSpecBooks.dblCostCenterEnter(Sender: TObject);
begin
...
procedure TreSpecBooks.dblLocCodeEnter(Sender: TObject);
begin

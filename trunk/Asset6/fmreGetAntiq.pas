...
type
  TreSpcMachin1 = class(TForm)
    ...
    quSpecMachineMyGoodCode: TLargeintField;
...
procedure TreSpcMachin1.DoRun(var mes :TMessage);
...
procedure TreSpcMachin1.DoPrint(var mes :TMessage);
begin
  ppViewer1.Print;
end;

procedure TreSpcMachin1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 FormDeactivate(nil);
{ recredit:=nil;}
 Action:=CaFree;
...
procedure TreSpcMachin1.FormActivate(Sender: TObject);
var mes:TMessage;
begin
   mes.Msg := FORM_STATE;
   mes.Lparam := 45;
...
procedure TreSpcMachin1.FormDeactivate(Sender: TObject);
var mes:TMessage;
begin
 mes.Msg:=FORM_DEACT;
 Application.MainForm.Dispatch(mes);
...
procedure TreSpcMachin1.spbPreview100PercentClick(Sender: TObject);
begin
...
procedure TreSpcMachin1.spbPreviewWidthClick(Sender: TObject);
begin
...
procedure TreSpcMachin1.spbPreviewWholeClick(Sender: TObject);
begin
...
procedure TreSpcMachin1.mskPreviewPageKeyPress(Sender: TObject; var Key: Char);
var
  liPage: Longint;
begin
...
procedure TreSpcMachin1.spbPreviewNextClick(Sender: TObject);
begin
  ppViewer1.NextPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreSpcMachin1.spbPreviewPriorClick(Sender: TObject);
begin
  ppViewer1.PriorPage;
  mskPreviewPage.text:=inttostr(ppViewer1.AbsolutePageNo);
end;

procedure TreSpcMachin1.mskPreviewPercentageKeyPress(Sender: TObject;
  var Key: Char);
var
...
procedure TreSpcMachin1.quFunFormalRowGetText(Sender: TField;
...
procedure TreSpcMachin1.ppDBText2GetText(Sender: TObject; var Text: String);
begin
  Text := inttostr(i div 3);
  i := i+1;
end;

procedure TreSpcMachin1.FormShow(Sender: TObject);
begin
...
procedure TreSpcMachin1.dblUnitCloseUp(Sender: TObject);
begin
...
procedure TreSpcMachin1.dblCostCenterCloseUp(Sender: TObject);
begin
      DabData.quDeployLoc.Close;
...
procedure TreSpcMachin1.dblCostCenterEnter(Sender: TObject);
begin
...
procedure TreSpcMachin1.dblLocCodeEnter(Sender: TObject);
begin

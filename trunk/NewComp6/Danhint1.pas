...
procedure Register;
begin
 RegisterComponents('Majid',[TDanHint]);
end;
...
//  MessageDlg('«Ã«“Â ‰œ«—Ìœ!!'+ #10#13+'œ— Â‰ê«„ ÿ—«ÕÌ  €ÌÌ— œÂÌœ', mtInformation,[mbOk], 0)
// else
...
begin
 if value <> fAbout then begin
  fAbout := cAbout;
//  MessageDlg('Majid Surany         '+ #10#13+ #10#13+
//             '                     '+ #10#13+
//             'mgso22002@yahoo.com           '+ #10#13+
//             'http://www.geocities.com/mgso22002 ',

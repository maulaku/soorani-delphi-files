object Country: TCountry
  ...
  object quCountry: TADOQuery
    ...
    Left = 552
    Top = 172
    object quCountrydegree: TStringField
      FieldName = 'degree'
      FixedChar = True
      Size = 10
    end
    object quCountryBad_Weather_Degree: TStringField
      FieldName = 'Bad_Weather_Degree'
      FixedChar = True
      Size = 10
    end
    object quCountryCountry_code: TSmallintField
      DisplayLabel = #1588#1600#1605#1600#1575#1585#1607
      FieldName = 'Country_code'
    end
    object quCountryCountry_name: TStringField
      DisplayLabel = #1606#1600#1600#1600#1575#1605' '#1603#1600#1588#1600#1608#1585
      FieldName = 'Country_name'
      Size = 40
    end
  end
  object qucounty1: TADOQuery
    Parameters = <
      item
        Name = 'p1'
        Attributes = [paSigned]
    ...
    Left = 495
    Top = 117
    object qucounty1country_code: TSmallintField
      FieldName = 'country_code'
    end
    object qucounty1province_code: TSmallintField
      FieldName = 'province_code'
    end
    object qucounty1county_code: TSmallintField
      FieldName = 'county_code'
    end
    object qucounty1county_name: TStringField
      FieldName = 'county_name'
      Size = 40
    end
    object qucounty1M_pay: TSmallintField
      FieldName = 'M_pay'
    end
    object qucounty1grade: TSmallintField
      FieldName = 'grade'
    end
    object qucounty1grp: TSmallintField
      FieldName = 'grp'
    end
    object qucounty1j_pay: TFloatField
      FieldName = 'j_pay'
    end
  end
  object qusection1: TADOQuery
    Parameters = <
      item
        Name = 'p1'
        Attributes = [paSigned]
    ...
    Left = 552
    Top = 117
    object qusection1country_code: TSmallintField
      FieldName = 'country_code'
    end
    object qusection1province_code: TSmallintField
      FieldName = 'province_code'
    end
    object qusection1county_code: TSmallintField
      FieldName = 'county_code'
    end
    object qusection1section_code: TSmallintField
      FieldName = 'section_code'
    end
    object qusection1section_name: TStringField
      FieldName = 'section_name'
      Size = 40
    end
    object qusection1grade: TSmallintField
      FieldName = 'grade'
    end
    object qusection1grp: TSmallintField
      FieldName = 'grp'
    end
    object qusection1m_pay: TSmallintField
      FieldName = 'm_pay'
    end
    object qusection1j_pay: TFloatField
      FieldName = 'j_pay'
    end
  end
  object quprovince: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select province.*,country.Country_name from province,country'
      'where  Country.Country_code=province.Country_code')
    Left = 495
    Top = 63
    object quprovincecountry_code: TSmallintField
      DisplayLabel = #1603#1583' '#1603#1588#1608#1585
      FieldName = 'country_code'
    end
    ...
    object quprovinceprovince_name: TStringField
      DisplayLabel = #1606#1600#1600#1600#1600#1600#1575#1605' '#1575#1587#1600#1578#1600#1575#1606
      FieldName = 'province_name'
      Size = 40
    end
    object quprovinceCountry_name: TStringField
      DisplayLabel = #1606#1600#1600#1575#1605' '#1603#1588#1608#1585
      FieldName = 'Country_name'
      Size = 40
    end
  end
  object quprovince1: TADOQuery
    Parameters = <
      item
        Name = 'p1'
        Attributes = [paSigned]
    ...
    Left = 495
    Top = 8
    object quprovince1country_code: TSmallintField
      FieldName = 'country_code'
    end
    object quprovince1province_code: TSmallintField
      FieldName = 'province_code'
    end
    object quprovince1province_name: TStringField
      FieldName = 'province_name'
      Size = 40
    end
  end
  object quvillage1: TADOQuery
    Parameters = <
      item
        Name = 'p1'
        Attributes = [paSigned]
    ...
    Left = 495
    Top = 172
    object quvillage1country_code: TSmallintField
      FieldName = 'country_code'
    end
    object quvillage1province_code: TSmallintField
      FieldName = 'province_code'
    end
    object quvillage1county_code: TSmallintField
      FieldName = 'county_code'
    end
    object quvillage1section_code: TSmallintField
      FieldName = 'section_code'
    end
    object quvillage1village_code: TSmallintField
      FieldName = 'village_code'
    end
    object quvillage1village_name: TStringField
      FieldName = 'village_name'
      Size = 40
    end
    object quvillage1m_pay: TSmallintField
      FieldName = 'm_pay'
    end
    object quvillage1grade: TSmallintField
      FieldName = 'grade'
    end
    object quvillage1grp: TSmallintField
      FieldName = 'grp'
    end
    object quvillage1j_pay: TFloatField
      FieldName = 'j_pay'
    end
  end
end

...
uses DabDmdle, fmMfrm, UCommon, fmVerify, fmSearch, fmSelCol4Print;
...
begin
  ...
  Search.ActiveDBGrid:=ActiveDBGrid;
...
{  Search.cbSearch1.ItemIndex:=0;
  Search.cbSearch2.ItemIndex:=1;
  Search.cbSearch3.ItemIndex:=2;
  Search.cbSearch4.ItemIndex:=3; }
